...
import org.sslab.adapter.chaincodeshim.shim.Chaincode.Response;
import org.sslab.adapter.chaincodeshim.shim.ChaincodeStub;
import org.sslab.adapter.chaincodeshim.shim.ledger.*;
    ...
    public Response invokeChaincode(final String chaincodeName, final List<byte[]> args, final String channel) {
        ...
        try {
            ...
            if (responseMessage.getType() == COMPLETED) {
                ...
                return new Response(Response.Status.forCode(r.getStatus()), r.getMessage(),
